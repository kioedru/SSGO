...
if __name__ == '__main__':
    ...
    protein_name2extname_dic, protein_extname2name_dic = get_proteins(margs.protein_file) #蛋白质id转化，把unport名字转成string
    ppi_graph = get_ppi_proteins(margs.ppi_file, margs.organism, margs.data_path)         #读ppi网络蛋白质排序
    
        
    preprocess_features(ppi_graph, protein_name2extname_dic, protein_extname2name_dic,
                           margs.data_path, margs.organism, margs.uniprot_file) #按ppi网络的蛋白质排序，分别构建特征，取特征数组
