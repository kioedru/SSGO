...
if __name__ == '__main__':
    ...
    parser.add_argument('-org', '--organism', type = str, help = "the organism")  #物种参数
    ...
    ppi_graph = get_ppi_proteins(margs.ppi_file, margs.organism, margs.data_path)  #读ppi网络蛋白质顺序，最终蛋白质都是采用ppi网络中的蛋白质名字
    
    evidences = set(['EXP', 'IDA', 'IPI', 'IMP', 'IGI', 'IEP', 'TAS', 'IC']) #本实验要选择的生物实验方法，从数据库选择一部分出来
    train_date = '20171231' #根据时间来划分训练和测试
    valid_date = '20201231'
