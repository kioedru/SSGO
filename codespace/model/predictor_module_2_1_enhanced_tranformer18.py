...
class Predictor(nn.Module):
    ...
    def forward(self, src):
        ...
        hs_org = torch.cat([ppi_feature_src, in_s], dim=0)  # 3,32,512
        ...
        fusion_ppi_feature = fusion_ppi_feature + hs_org
        fusion_seq = fusion_seq + hs_org

        fusion_ppi_feature = self.hs_ppi_feature_norm(fusion_ppi_feature)
        fusion_seq = self.hs_seq_norm(fusion_seq)
