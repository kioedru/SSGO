...
from codespace.model.Agent_Attention import AgentAttention
...
def build_transformerEncoder(args):
    return EncoderTransformer(
        ...
        seq_len=args.seq_len,  # 做注意力的序列长度
    )
