...
class Fusion_Model17(nn.Module):
    ...
    def forward(self, hs_fc, hs_model17):
...
class Fusion_Model39(nn.Module):
    ...
    def forward(self, hs_fc, hs_model39):
        ...
        model39_fusion = self.decoder_model39(fusion_hs)  # 32,45
...
class Predictor(nn.Module):
    ...
    def forward(self, src):
        ...
        fusion_model17 = self.fusion_model17(hs_fc, hs_model17)  # 32,45
