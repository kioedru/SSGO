...
class Predictor(nn.Module):
    ...
    def forward(self, src):
        ...
        hs_org_ppi_feature = torch.cat([hs_org, hs_org], dim=0)  # 2,32,512
        hs_ppi_feature = self.ppi_feature_fison(
            hs_ppi_feature, hs_org_ppi_feature, hs_org_ppi_feature
        )[0]
        hs_seq = self.seq_fison(hs_seq, hs_org, hs_org)[0]  # 1,32,512
