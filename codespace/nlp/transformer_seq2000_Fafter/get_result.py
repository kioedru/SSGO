...
def get_finetune_data(usefor, aspect, organism_num):
    ...
    labels = read_labels_F_nlp(usefor, aspect, organism_num)
...
def main_worker(args):
    ...
    model_dict = torch.load(
        "/home/Kioedru/code/SSGO/codespace/nlp/transformer_seq2000_Fafter/F/1329765522/50:100/final_model.pkl"
    )
    ...
    pd.to_pickle(
        predict,
        f"/home/Kioedru/code/SSGO/codespace/nlp/transformer_seq2000_Fafter/predict.pkl",
    )
    pd.to_pickle(
        label,
        f"/home/Kioedru/code/SSGO/codespace/nlp/transformer_seq2000_Fafter/label.pkl",
    )
