...
def main_worker(args):
    ...
    model_dict = torch.load(
        "/home/Kioedru/code/SSGO/codespace/finetune/mamba3_seq2000/F/132976111/50:100/final_model.pkl"
    )
    ...
    pd.to_pickle(
        predict,
        f"/home/Kioedru/code/SSGO/codespace/nlp/mamba3_seq2000_F/predict.pkl",
    )
    pd.to_pickle(
        label,
        f"/home/Kioedru/code/SSGO/codespace/nlp/mamba3_seq2000_F/label.pkl",
    )
