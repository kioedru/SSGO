...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion/finetune_model32.py --model_num 32 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion/finetune_model32.py --model_num 32 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion/finetune_model32.py --model_num 32 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
...
def main_worker(args):
    ...
    for param in predictor_model.seq_pre_model.parameters():
        param.requires_grad = False
