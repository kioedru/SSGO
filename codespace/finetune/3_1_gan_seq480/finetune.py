...
import csv
from codespace.model.predictor_module_3_1_gan import build_predictor
...
def main():
    ...
    args.model_name = f"3_1_gan_seq480"
    args.seq_model_name = f"seq480_gan_encoder"
    args.ppi_feature_model_name = f"transformer_seq480"
    ...
    sys.path.append(os.path.join(args.path, "pretrain", args.ppi_feature_model_name))
