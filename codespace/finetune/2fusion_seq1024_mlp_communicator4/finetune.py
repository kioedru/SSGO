...
import csv
from codespace.model.predictor_module_2fusion_mlp_communicator4 import build_predictor
import sys
...
def main():
    ...
    args.finetune_path = os.path.join(
        args.path,
        "finetune",
        "2fusion_seq1024_mlp_communicator4",
        args.aspect,
        f"{args.seed}",
    ...
    args.epoch_performance_path = os.path.join(
        args.finetune_path, f"epoch_performance_lr=1e-4.csv"
    )
