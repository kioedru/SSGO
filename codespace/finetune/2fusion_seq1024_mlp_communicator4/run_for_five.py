    ...
    for pretrain_update in pretrain_updates:
        for aspect in aspects:
            for seed in seeds:
                ...
                command = f"nohup python /home/Kioedru/code/SSGO/codespace/finetune/2fusion_seq1024_mlp_communicator4/finetune.py --pretrain-update {pretrain_update} --epochs {epoch} --seed {seed}  --aspect {aspect} --num_class {num_class[aspect]} &"
