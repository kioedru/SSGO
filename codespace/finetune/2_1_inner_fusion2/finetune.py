...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion2/finetune.py --model_num 44 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion2/finetune.py --model_num 44 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion2/finetune.py --model_num 44 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    args.org = "9606"
    args.model_name = f"2_1_inner_fusion2_{args.model_num}_{args.seq_feature}"
...
def main_worker(args):
    ...
    if args.model_num == "42":
        from codespace.model.predictor_module_2_1_inner42 import build_predictor
    elif args.model_num == "43":
        from codespace.model.predictor_module_2_1_inner43 import build_predictor
    elif args.model_num == "44":
        from codespace.model.predictor_module_2_1_inner44 import build_predictor
