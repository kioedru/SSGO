...
import csv
from codespace.model.predictor_module_2_1_gate_cross_attention import build_predictor
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_moe/finetune.py --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_moe/finetune.py --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_moe/finetune.py --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    args.model_name = f"2_1_moe21_{args.seq_feature}"
