...
# 配置 trial
experiment.config.trial_command = f"python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_modelist/finetune_new.py --model_num 45 --seed 1329765522 --seq_feature seq1024 --aspect P --num_class 45 --device cuda:0 --nni True"
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_modelist/nni_P.py &
