...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_modelist/finetune_new.py --model_num 47 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_modelist/finetune_new.py --model_num 47 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_modelist/finetune_new.py --model_num 47 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    params = {
        "lr": 0.015523604819802413,
        "pre_lr": 0.0008825509316452103,
        "seq_pre_lr": 0.013169513549754992,
        "pre_lr_model17": 0.021556585267450103,
        "seq_pre_lr_model17": 0.00045532967912858483,
        "dropout": 0.10830946446474138,
        "lr_model17": 0.00683113634336181,
        "lr_model39": 0.00012095791117734693,
    }
    # params = {}
    if args.param == 1:
        params = {
            ...
            "pre_lr_model17": args.pre_lr_model17,
            "seq_pre_lr_model17": args.seq_pre_lr_model17,
    ...
    args.epoch_performance_path = os.path.join(
        args.finetune_path,
        f"0epoch_performance_lr:{params['lr']},dropout:{params['dropout']},pre_lr:{params['pre_lr']},seq_pre_lr:{params['seq_pre_lr']}.csv",
    )
    ...
    args.pre_lr_model17 = params["pre_lr_model17"]
    args.seq_pre_lr_model17 = params["seq_pre_lr_model17"]
...
def finetune(
    ...
    for epoch in range(num_epochs):
        ...
        # 每轮都打印一次学习率
        print(
            f"Epoch {epoch}, learning rate: {optimizer.param_groups[0]['lr']}, {optimizer.param_groups[1]['lr']}, {optimizer.param_groups[2]['lr']}, {optimizer.param_groups[3]['lr']}, {optimizer.param_groups[4]['lr']}, {optimizer.param_groups[5]['lr']}, {optimizer.param_groups[6]['lr']}"
        )
