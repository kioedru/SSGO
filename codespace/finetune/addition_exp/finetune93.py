...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/addition_exp/finetune93.py --model_num 93 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/addition_exp/finetune93.py --model_num 93 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/addition_exp/finetune93.py --model_num 93 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        ...
        # F1
        params = {
            "lr": 0.00962211229575246,
            "pre_lr": 0.0019598756639210156,
            "seq_pre_lr": 0.000021628435758653394,
            "dropout": 0.446092377850383,
        }
    elif args.aspect == "C":
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "93":
        from codespace.model.predictor_module_addition_exp93 import build_predictor
