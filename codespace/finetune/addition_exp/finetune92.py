...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/addition_exp/finetune92.py --model_num 92 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/addition_exp/finetune92.py --model_num 92 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/addition_exp/finetune92.py --model_num 92 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        # P1
        # params = {
        #     "lr": 0.004693950740575528,
        #     "pre_lr": 0.002411490553308118,
        #     "seq_pre_lr": 0.0024699281100661994,
        #     "dropout": 0.24427716324726118,
        # }
        # P2
        # params = {
        #     "lr": 0.04478635390189407,
        #     "pre_lr": 0.0004220230331443037,
        #     "seq_pre_lr": 0.00227017104366018,
        #     "dropout": 0.3769031452294612,
        # }
        # P3
        # params = {
        #     "lr": 0.00021622576847062121,
        #     "pre_lr": 0.0014151928444303648,
        #     "seq_pre_lr": 0.0033724304424927977,
        #     "dropout": 0.28665422862255374,
        # }
        # P4
        params = {
            "lr": 0.00020621453666322712,
            "pre_lr": 0.039237067061093193,
            "seq_pre_lr": 0.000726435040635411,
            "dropout": 0.36224634525916155,
        }
    elif args.aspect == "F":
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "92":
        from codespace.model.predictor_module_addition_exp92 import build_predictor
