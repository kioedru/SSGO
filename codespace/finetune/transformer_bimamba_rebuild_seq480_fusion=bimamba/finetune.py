...
def main():
    ...
    print(params)
    args.fusion = "bimamba"  # transformer bimamba mamba
    args.input_num = 3
    args.epochs = 100
    ...
    args.model_name = f"transformer_bimamba_rebuild_seq480_fusion={args.fusion}"
    args.seq_model_name = f"one_feature_only"
