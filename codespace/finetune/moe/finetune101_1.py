...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_1.py --model_num 101_1 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_1.py --model_num 101_1 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_1.py --model_num 101_1 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        params = {
            "lr": 0.0010817945634923705,
            "pre_lr": 0.01757813598424151,
            "seq_pre_lr": 0.00013867534039551114,
            "dropout": 0.2247862463781598,
        }
    elif args.aspect == "F":
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "101_1":
        from codespace.model.predictor_module_moe101_1 import build_predictor
