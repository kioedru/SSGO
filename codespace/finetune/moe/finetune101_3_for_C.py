...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_3_for_C.py --model_num 101_3 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    args.epoch_performance_path = os.path.join(
        args.finetune_path,
        f"50epoch_performance_lr:{params['lr']},dropout:{params['dropout']},pre_lr:{params['pre_lr']},seq_pre_lr:{params['seq_pre_lr']}.csv",
    )
