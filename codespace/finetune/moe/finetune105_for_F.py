...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune105.py --model_num 105 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune105.py --model_num 105 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune105.py --model_num 105 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        params = {
            "lr": 0.001858559702919374,
            "pre_lr": 0.000014509411132187307,
            "seq_pre_lr": 0.09873667723621792,
            "dropout": 0.16164407004035097,
        }
    elif args.aspect == "F":
        params = {
            "lr": 0.001837739965313922,
            "pre_lr": 0.0003378261351252617,
            "seq_pre_lr": 0.00002657847694109659,
            "dropout": 0.29494530459389084,
        }
    elif args.aspect == "C":
        params = {
    ...
    args.epoch_performance_path = os.path.join(
        args.finetune_path,
        f"42_epoch_performance_lr:{params['lr']},dropout:{params['dropout']},pre_lr:{params['pre_lr']},seq_pre_lr:{params['seq_pre_lr']}.csv",
    )
...
def main_worker(args):
    ...
    if args.model_num == "105":
        from codespace.model.predictor_module_moe105 import build_predictor
    ...
    if args.nni:
        steplr = lr_scheduler.StepLR(predictor_model_optimizer, 42)
    else:
        steplr = lr_scheduler.StepLR(predictor_model_optimizer, 42)
    patience = 10
    changed_lr = False
