...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_3_for_P.py --model_num 101_3 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_3_for_P.py --model_num 101_3 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_3_for_P.py --model_num 101_3 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        params = {
            "lr": 0.002281752503302784,
            "pre_lr": 0.0021313342785279367,
            "seq_pre_lr": 0.002446702062822413,
            "dropout": 0.15954957330258066,
        }
    elif args.aspect == "F":
        params = {
        ...
        params = {
            "lr": 0.0005582455706834517,
            "pre_lr": 0.0006061332031388601,
            "seq_pre_lr": 0.002824711384630902,
            "dropout": 0.34425435951780325,
        }
    # params = {}
    if args.param == 1:
        params = {
    ...
    args.org = "9606"
    args.model_name = f"moe_{args.model_num}_{args.seq_feature}_for_P"
...
def main_worker(args):
    ...
    if args.model_num == "101_3":
        from codespace.model.predictor_module_moe101_3 import build_predictor
    ...
    if args.nni:
        ...
        if args.aspect == "P":
            steplr = lr_scheduler.StepLR(predictor_model_optimizer, 25)
        elif args.aspect == "F":
            steplr = lr_scheduler.StepLR(predictor_model_optimizer, 50)
        elif args.aspect == "C":
            steplr = lr_scheduler.StepLR(predictor_model_optimizer, 24)
    patience = 10
    changed_lr = False
