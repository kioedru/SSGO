...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101.py --model_num 101 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101.py --model_num 101 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101.py --model_num 101 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        params = {
            "lr": 0.0006300990144963344,
            "pre_lr": 0.02990810577313764,
            "seq_pre_lr": 0.003734770364444602,
            "dropout": 0.3589249522358591,
        }
    elif args.aspect == "F":
        params = {
            "lr": 0.00012075910745329323,
            "pre_lr": 0.06445960958941384,
            "seq_pre_lr": 0.09345111634102349,
            "dropout": 0.37746686042547273,
        }
    elif args.aspect == "C":
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "101":
        from codespace.model.predictor_module_moe101 import build_predictor
