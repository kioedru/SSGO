...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_2.py --model_num 101_2 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_2.py --model_num 101_2 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune101_2.py --model_num 101_2 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        params = {
            "lr": 0.0018799630250134964,
            "pre_lr": 0.00009587822714410014,
            "seq_pre_lr": 0.036931518647186315,
            "dropout": 0.25125832899698775,
        }
    elif args.aspect == "F":
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "101_2":
        from codespace.model.predictor_module_moe101_2 import build_predictor
