...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune104.py --model_num 104 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune104.py --model_num 104 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/moe/finetune104.py --model_num 104 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
...
def main_worker(args):
    ...
    if args.model_num == "104":
        from codespace.model.predictor_module_moe104 import build_predictor
    ...
    predictor_model_param_dicts = [
        ...
        },
        {
            "params": [
                p
                for n, p in predictor_model.fc_decoder_for_model17.named_parameters()
                if p.requires_grad
            ],
        },
        {
            "params": [
                p
                for n, p in predictor_model.fc_decoder_for_model39.named_parameters()
                if p.requires_grad
            ],
        },
    ]
