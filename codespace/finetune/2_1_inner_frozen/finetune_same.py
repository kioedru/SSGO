...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_frozen/finetune_same.py --model_num 61 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765519 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_frozen/finetune_same.py --model_num 61 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_frozen/finetune_same.py --model_num 61 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    args.epoch_performance_path = os.path.join(
        args.finetune_path,
        f"lr:{params['lr']},dropout:{params['dropout']}.csv",
    )
...
def main_worker(args):
    ...
    elif args.model_num == "62":
        from codespace.model.predictor_module_2_1_modelist62 import build_predictor
...
def finetune(
    ...
    for epoch in range(num_epochs):
        ...
        # 每轮都打印一次学习率
        print(
            f"Epoch {epoch}, lr: {optimizer.param_groups[2]['lr']},dropout: {args.dropout}"
        )
