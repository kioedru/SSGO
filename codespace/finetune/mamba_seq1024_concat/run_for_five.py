    ...
    for pretrain_update in pretrain_updates:
        for aspect in aspects:
            for seed in seeds:
                ...
                command = f"nohup python /home/Kioedru/code/SSGO/codespace/finetune/mamba_seq1024_concat/finetune.py --pretrain-update {pretrain_update} --epochs {epoch} --seed {seed}  --aspect {aspect} --num_class {num_class[aspect]} &"
