...
def parser_args():
    ...
    parser.add_argument(
        "--seed", default=1329765519, type=int, help="seed for initializing training. "
    )
    parser.add_argument(
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion3/finetune.py --model_num 51 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765519 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion3/finetune.py --model_num 51 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion3/finetune.py --model_num 51 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:1 &
def main():
    args = get_args()
    ...
    params = {
        ...
        "pre_lr": 0.0024334145914109615,
        "seq_pre_lr": 0.00014303850645524388,
        "dropout": 0.11718062827768456,
    }
    ...
    args.org = "9606"
    args.model_name = f"2_1_inner_fusion{args.model_num}_{args.seq_feature}"
...
def main_worker(args):
    ...
    if args.model_num == "51":
        from codespace.model.predictor_module_2_1_inner_51 import build_predictor
    elif args.model_num == "52":
        from codespace.model.predictor_module_2_1_inner_52 import build_predictor
        ...
        predictor_model_param_dicts.append(
            {
                "params": [
                    p
                    for n, p in predictor_model.fusion_ppi_feature.named_parameters()
                    if p.requires_grad
                ],
                "lr": args.pre_lr,
            },
        ...
        predictor_model_param_dicts.append(
            {
                "params": [
                    p
                    for n, p in predictor_model.fc_ppi_feature.named_parameters()
                    if p.requires_grad
                ],
                "lr": args.pre_lr,
            },
        ...
        predictor_model_param_dicts.append(
            {
                "params": [
                    p
                    for n, p in predictor_model.fusion_seq.named_parameters()
                    if p.requires_grad
                ],
                "lr": args.seq_pre_lr,
            },
        ...
        predictor_model_param_dicts.append(
            {
                "params": [
                    p
                    for n, p in predictor_model.fc_seq.named_parameters()
                    if p.requires_grad
                ],
                "lr": args.seq_pre_lr,
            },
