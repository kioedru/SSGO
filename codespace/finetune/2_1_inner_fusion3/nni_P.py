...
# 配置 trial
experiment.config.trial_command = f"python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion3/finetune.py --model_num 51 --seed {seed} --seq_feature seq1024 --aspect P --num_class 45 --device cuda:1 --nni True"
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_inner_fusion3/nni_P.py &
