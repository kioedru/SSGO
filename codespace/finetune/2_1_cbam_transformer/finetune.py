...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_cbam_transformer/finetune.py --seq_feature seq1024 --aspect P --num_class 45 &
def main():
    args = get_args()
    ...
    args.model_name = (
        f"2_1_cbam1_transformer" if args.cbam == "1" else f"2_1_cbam_transformer"
    )
...
def main_worker(args):
    if args.cbam == "1":
        from codespace.model.predictor_module_2_1_cbam1_transformer import (
            build_predictor,
        )
    else:
        from codespace.model.predictor_module_2_1_cbam_transformer import (
            build_predictor,
        )
