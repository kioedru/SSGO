...
# 配置 trial
experiment.config.trial_command = f"python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_enhanced2_transformer/finetune.py --seed 1329765522 --seq_feature seq1024 --aspect F --num_class 38 --device cuda:0 --nni True"
