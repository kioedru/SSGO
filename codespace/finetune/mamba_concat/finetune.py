...
def get_finetune_data(usefor, aspect, organism_num):
    ...
    return feature, ppi_matrix, labels
...
def get_dataset(aspect, organism_num):
    ...
    # )
    train_feature, train_ppi_matrix, train_labels = get_finetune_data(
        "train", aspect, organism_num
    )
    valid_feature, valid_ppi_matrix, valid_labels = get_finetune_data(
        "valid", aspect, organism_num
    )
    test_feature, test_ppi_matrix, test_labels = get_finetune_data(
        "test", aspect, organism_num
    )
    ...
    # )
    train_dataset = multimodesDataset(
        2, [combine_ppi_matrix, combine_feature], combine_labels
    )
    test_dataset = multimodesDataset(2, [test_ppi_matrix, test_feature], test_labels)
    # modefeature_lens = [
