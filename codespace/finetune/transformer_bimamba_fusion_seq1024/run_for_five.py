...
def run_finetune(aspect, epoch, pretrain_update, seed):
    ...
    command = f"nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/transformer_bimamba_fusion_seq1024/finetune.py --device {device}  --seed {seed}  --aspect {aspect} --num_class {num_class[aspect]} &"
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/transformer_bimamba_fusion_seq1024/run_for_five.py &
