...
import csv
from codespace.model.predictor_module_2_1_cbam import build_predictor
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_complicate_fusion/finetune.py --fusion CBAM_0 --fusion2 transformer --seq_feature seq1024 --aspect P --num_class 45 &
def main():
    args = get_args()
    ...
    # args.fusion = "CBAM_0"  # CBAM_0
    # args.fusion2='transformer'#transformer
    # args.aspect = "P"
    ...
    args.model_name = (
        f"2_1_{args.seq_feature}_complicate_fusion={args.fusion}+{args.fusion2}"
    )
