...
def parser_args():
    ...
    parser.add_argument(
        "--aspect", type=str, default="F", choices=["P", "F", "C"], help="GO aspect"
    )
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune82_for_feature.py --model_num 82 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune82_for_feature.py --model_num 82 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune82_for_feature.py --model_num 82 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
...
def main_worker(args):
    ...
    if args.model_num == "82":
        from codespace.model.predictor_module_2_1_final82_for_feature import (
            build_predictor,
        )
    ...
    if args.aspect == "P":
        ...
        model_dict = torch.load(
            "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/P/12301281/50:100/seed_12301281_final_model.pkl",
            map_location=args.device,
        )
        ...
        # seed=1329765529
        # model_dict = torch.load(
        #     "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/F/1329765529/50:100/epoch_model/42_model.pkl",
        #     map_location=args.device,
        # ).state_dict()
        # seed=12301281
        # model_dict = torch.load(
        #     "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/F/12301281/50:100/epoch_model/31_model.pkl",
        #     map_location=args.device,
        # ).state_dict()
        # seed=132976111
        # model_dict = torch.load(
        #     "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/F/132976111/50:100/epoch_model/26_model.pkl",
        #     map_location=args.device,
        # ).state_dict()
        # # seed=1329765522
        # model_dict = torch.load(
        #     "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/F/1329765522/50:100/epoch_model/10_model.pkl",
        #     map_location=args.device,
        # ).state_dict()
        # # seed=1329765525
        model_dict = torch.load(
            "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/F/1329765525/50:100/epoch_model/19_model.pkl",
            map_location=args.device,
        ).state_dict()
    elif args.aspect == "C":
        model_dict = torch.load(
            "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/C/1329765529/50:100/epoch_model/53_model.pkl",
            map_location=args.device,
        ).state_dict()

    new_model_dict = predictor_model.state_dict()
    new_model_dict.update(model_dict)
    predictor_model.load_state_dict(new_model_dict)
    with torch.no_grad():
        perf, fusion_model17, hs_model39, weighted_gate_hs = evaluate(
            train_loader, predictor_model, args.device
        )
        print(perf)
        pd.to_pickle(
            fusion_model17,
            os.path.join(
                "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/feature_output",
                f"{args.aspect}_fusion_model17.pkl",
            ),
        )
        pd.to_pickle(
            hs_model39,
        ...
        pd.to_pickle(
            ...
            os.path.join(
                "/home/Kioedru/code/SSGO/codespace/finetune/2_1_final/2_1_final_82_seq1024/9606/feature_output",
                f"{args.aspect}_weighted_gate_hs.pkl",
            ),
        )
...
def evaluate(test_loader, predictor_model, device):
    ...
    for proteins, label in test_loader:
        ...
        # compute output
        rec, output, fusion_model17, hs_model39, weighted_gate_hs = predictor_model(
            proteins
        )
    ...
    return perf, all_fusion_model17, all_hs_model39, all_weighted_gate_hs
