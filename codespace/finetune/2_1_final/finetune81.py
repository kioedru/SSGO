...
def main_worker(args):
    ...
    if args.model_num == "81":
        from codespace.model.predictor_module_2_1_final81 import build_predictor
    ...
    pre_model17 = torch.load(
        "/home/Kioedru/code/SSGO/codespace/finetune/2_1_simple/2_1_seq1024_simple_fusion=transformer/9606/P/1329765522/50:100/epoch_model/epoch87_model_m-aupr0.43607825434900227_Fmax0.4743589743589744.pkl",
...
def finetune(
    ...
    for epoch in range(num_epochs):
        ...
        # 每轮都打印一次学习率
        print(
            f"Epoch {epoch}, pre_lr: {optimizer.param_groups[0]['lr']}, seq_pre_lr: {optimizer.param_groups[1]['lr']}, lr_model39: {optimizer.param_groups[2]['lr']}, lr: {optimizer.param_groups[3]['lr']}"
        )
