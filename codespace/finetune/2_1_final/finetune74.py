...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune74.py --model_num 74 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune74.py --model_num 74 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune74.py --model_num 74 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
...
def main_worker(args):
    ...
    elif args.model_num == "74":
        from codespace.model.predictor_module_2_1_final74 import build_predictor
...
def finetune(
    ...
    for epoch in range(num_epochs):
        ...
        # 每轮都打印一次学习率
        print(
            f"Epoch {epoch}, learning rate: {optimizer.param_groups[0]['lr']}, {optimizer.param_groups[1]['lr']}, {optimizer.param_groups[2]['lr']}, {optimizer.param_groups[3]['lr']}, {optimizer.param_groups[4]['lr']}, {optimizer.param_groups[5]['lr']}"
        )
