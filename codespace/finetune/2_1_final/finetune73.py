...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune73.py --model_num 73 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune73.py --model_num 71 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune73.py --model_num 71 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    params = {
        "lr": 0.04378824357208102,
        "pre_lr": 0.005657411779305045,
        "seq_pre_lr": 0.000057539474808626274,
        "pre_lr_model17": 0.08431715076877613,
        "seq_pre_lr_model17": 0.00013770832634494833,
        "dropout": 0.3517092678996201,
        "lr_model17": 0.0021093367300298455,
    }
    # params = {}
    if args.param == 1:
        params = {
...
def main_worker(args):
    ...
    elif args.model_num == "73":
        from codespace.model.predictor_module_2_1_final73 import build_predictor
