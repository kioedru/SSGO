...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune2.py --model_num 71 --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:1 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune.py --model_num 71 --seq_feature seq1024 --aspect F --num_class 38 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune.py --model_num 71 --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    params = {
        "lr": 0.00012539838832801187,
        "pre_lr": 0.00421180357117363,
        "seq_pre_lr": 0.000011447327850158338,
        "pre_lr_model17": 0.02178355155847717,
        "seq_pre_lr_model17": 0.000019480330115225652,
        "dropout": 0.30964832932033914,
        "lr_model17": 0.00153533115284801,
        "lr_model39": 0.00008109383713900161,
    }
    # params = {}
    if args.param == 1:
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "71":
        from codespace.model.predictor_module_2_1_final71 import build_predictor
    elif args.model_num == "72":
        from codespace.model.predictor_module_2_1_final72 import build_predictor
