...
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune82_soft.py --model_num 82_soft --seq_feature seq1024 --aspect P --num_class 45 --seed 1329765522 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune82_soft.py --model_num 82_soft --seq_feature seq1024 --aspect F --num_class 38 --seed 12301281 --device cuda:0 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/finetune/2_1_final/finetune82_soft.py --model_num 82_soft --seq_feature seq1024 --aspect C --num_class 35 --seed 1329765522 --device cuda:0 &
def main():
    args = get_args()
    ...
    if args.aspect == "P":
        params = {
            "lr": 0.0017950144668478986,
            "pre_lr": 0.000012060260908451693,
            "seq_pre_lr": 0.002813939223462202,
            "dropout": 0.12411420054555396,
        }
    elif args.aspect == "F":
        # params = {
        #     "lr": 0.027955251616962582,
        #     "pre_lr": 0.001152921658209379,
        #     "seq_pre_lr": 0.005629146108016626,
        #     "dropout": 0.3748489780277495,
        # }
        # F2
        params = {
            "lr": 0.055050838495311206,
            "pre_lr": 0.0023419460517569617,
            "seq_pre_lr": 0.000013247811981375331,
            "dropout": 0.2092905220073995,
        }
    elif args.aspect == "C":
        params = {
...
def main_worker(args):
    ...
    if args.model_num == "82_soft":
        from codespace.model.predictor_module_2_1_final82_soft import build_predictor
