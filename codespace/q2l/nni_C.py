...
# 配置 trial
experiment.config.trial_command = f"python -u /home/Kioedru/code/SSGO/codespace/q2l/finetune0.py --device cuda:0 --seed 1329765522 --seq_feature seq1024 --aspect C --num_class 35 --nni True"
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/q2l/nni_C.py &
