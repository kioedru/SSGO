...
import csv
from codespace.q2l.demo_seq.predictor_module_q2l import Predictor
...
# nohup python -u /home/Kioedru/code/SSGO/codespace/q2l/demo_seq/finetune.py --device cuda:1 --seed 1329765522 --aspect P --num_class 45 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/q2l/demo_seq/finetune.py --device cuda:1 --seed 1329765522 --aspect F --num_class 38 &
# nohup python -u /home/Kioedru/code/SSGO/codespace/q2l/demo_seq/finetune.py --device cuda:1 --seed 1329765522 --aspect C --num_class 35 &
...
def main():
    ...
    froze_name = {0: "thaw", 1: "frozen", 2: "half"}
    args.org = "9606"

    args.model_name = f"demo_seq"
...
def main_worker(args):
    ...
    # 创建预测模型
    predictor_model = Predictor(dropout=args.dropout, num_class=args.num_class)
...
def finetune(
    ...
    for epoch in range(num_epochs):
        ...
        for protein_data, label in data_loader:
            ...
            output = net(protein_data[2])
            l = loss(output, label, rec=None)
            optimizer.zero_grad()
            l.backward()
...
def evaluate(test_loader, predictor_model, device):
    ...
    for proteins, label in test_loader:
        ...
        # compute output
        output = predictor_model(proteins[2])
