...
def get_ssl_datasets(organism_num, feature_name="ppi"):
    if feature_name == "ppi":
        ...
        feature = read_seq_embed_avgpool_esm2_480(organism_num)
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/one_feature_only/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/one_feature_only/9606/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/one_feature_only/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/one_feature_only/9606/pretrain_transformer_seq1024.log 2>&1 &
def main():
    args = get_args()
