...
from codespace.pretrain.mamba_concat.pretrain_model_mamba import (
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/mamba_concat/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/mamba_concat/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/mamba_concat/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/mamba_concat/10090/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.org = "mouse"
    args.model_name = f"mamba_concat"
