...
from codespace.pretrain.transformer_bimamba_fusion_seq1024.pretrain_model import (
...
def get_ssl_datasets(organism_num):
    ...
    seq = read_seq_embed_avgpool_prott5_1024(organism_num)
    ...
    return full_dataset, [ppi_matrix.shape[1], feature.shape[1], seq.shape[1]]
...
# in kioedru:
# nohup python -u /home/Kioedru/code/SSGO/codespace/pretrain/transformer_bimamba_fusion_seq1024/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/bimamba_seq1024/pretrain.log 2>&1 &
# in Kioedru:
# nohup python -u /home/Kioedru/code/SSGO/codespace/pretrain/transformer_bimamba_fusion_seq1024/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/transformer_bimamba_fusion_seq1024/9606/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.org = "human"
    args.model_name = f"transformer_bimamba_fusion_seq1024"
...
def pre_train(
    ...
    for epoch in range(num_epochs):
        ...
        for protein_data in full_loader:
            ...
            ori_transformer = copy.deepcopy(protein_data)
            ori_bimamba = copy.deepcopy(protein_data)
            ori_transformer.extend(ori_bimamba)
            ori = ori_transformer
