...
from codespace.pretrain.AA_seq1024.pretrain_model import (
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/AA_seq1024/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/AA_seq1024/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/AA_seq1024/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/AA_seq1024/9606/pretrain.log 2>&1 &
def main():
    args = get_args()
    args.device = "cuda:0"
    args.org = "human"
    args.model_name = f"AA_seq1024"
    ...
    check_and_create_folder(
        os.path.join(args.pretrain_path, args.model_name, org2num[args.org])
    )
