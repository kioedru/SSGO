...
from codespace.pretrain.bimamba_seq2000.pretrain_model_bimamba import (
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/bimamba_seq2000/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/bimamba_seq2000/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/bimamba_seq2000/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/bimamba_seq2000/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.model_name = f"bimamba_seq2000"
