...
from codespace.model.multihead_attention_bimamba import (
...
class Pre_Train_Model(nn.Module):
    ...
    def forward(self, src, residue):
        ...
        in_s = self.seq_mamba(in_s)  # residue_score[32,2000,480]
        in_s = torch.mean(in_s, 1)  # [32,480]
        # 是否考虑做归一化
        ori_3 = in_s
...
def build_Pre_Train_Model(args):
    seq_mamba = EncoderTransformer(
        dim_feedforward=args.modesfeature_len,
