...
from codespace.pretrain.mamba_seq480.pretrain_model_mamba import (
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/mamba_seq480/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/mamba_seq480/9606/pretrain.log 2>&1 &
# in Kioedru:
# nohup python -u /home/Kioedru/code/SSGO/codespace/pretrain/mamba_seq480/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/mamba_seq480/9606/pretrain_0.log 2>&1 &
def main():
    args = get_args()
    args.seed = int(1329765522)
    args.dim_feedforward = int(512)
    args.nheads = int(8)
    args.dropout = float(0.2)  # 0.1
    args.attention_layers = int(6)
    args.batch_size = int(32)
    args.activation = "gelu"
    args.epochs = int(5000)
    args.lr = float(1e-4)  # 1e-5
    args.device = "cuda:0"

    args.org = "human"
    args.model_name = f"mamba_seq480"
    ...
    args.pretrain_model = os.path.join(
        ...
        args.model_name,
        org2num[args.org],
        f"{args.model_name}_lr:{args.lr}_dropout:{args.dropout}.pkl",
    )
    args.performance_path = os.path.join(
        args.pretrain_path,
        args.model_name,
        org2num[args.org],
        f"pretrain_loss_lr:{args.lr}_dropout:{args.dropout}.csv",
    )
