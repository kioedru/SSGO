...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/transformer_seq2000/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/transformer_seq2000/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/transformer_seq2000/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/transformer_seq2000/10090/pretrain.log 2>&1 &
def main():
    args = get_args()
    args.org = "mouse"
