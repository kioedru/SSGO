...
from codespace.pretrain.AA.pretrain_model import (
...
def get_ssl_datasets(organism_num):
    ...
    full_dataset = multimodesFullDataset(2, [ppi_matrix, feature])
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/AA/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/AA/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/AA/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/AA/9606/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.org = "human"
    args.model_name = f"AA"
