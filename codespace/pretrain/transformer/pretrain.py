...
from codespace.pretrain.transformer.pretrain_model_transformer import (
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/transformer/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/transformer/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/transformer/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/transformer/9606/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.org = "human"
    args.model_name = f"transformer"
