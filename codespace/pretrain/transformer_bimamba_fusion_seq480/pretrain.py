...
from codespace.pretrain.transformer_bimamba_fusion_seq480.pretrain_model import (
...
# in kioedru:
# nohup python -u /home/Kioedru/code/SSGO/codespace/pretrain/transformer_bimamba_fusion_seq480/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/bimamba_seq480/pretrain.log 2>&1 &
# in Kioedru:
# nohup python -u /home/Kioedru/code/SSGO/codespace/pretrain/transformer_bimamba_fusion_seq480/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/transformer_bimamba_fusion_seq480/9606/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.org = "human"
    args.model_name = f"transformer_bimamba_fusion_seq480"
