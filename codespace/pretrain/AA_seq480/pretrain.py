...
from codespace.pretrain.AA_seq480.pretrain_model import (
...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/AA_seq480/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/AA_seq480/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/AA_seq480/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/AA_seq480/9606/pretrain.log 2>&1 &
def main():
    args = get_args()
    args.device = "cuda:0"
    args.org = "human"
    args.model_name = f"AA_seq480"
