...
# in kioedru:
# nohup python /home/kioedru/code/SSGO/codespace/pretrain/mamba_seq1024_new_concat/pretrain.py> /home/kioedru/code/SSGO/codespace/pretrain/mamba_seq1024_new_concat/pretrain.log 2>&1 &
# in Kioedru:
# nohup python /home/Kioedru/code/SSGO/codespace/pretrain/mamba_seq1024_new_concat/pretrain.py> /home/Kioedru/code/SSGO/codespace/pretrain/mamba_seq1024_new_concat/9606/pretrain.log 2>&1 &
def main():
    args = get_args()

    args.org = "human"
    args.model_name = f"mamba_seq1024_new_concat"
